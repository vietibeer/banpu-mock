...
let database2 = tasksListData.data
...
const userPermission = {
  DEFAULT: {
    visit: ['1', '21', '7', '5', '51', '52', '53', '54', '6', '61', '62', '63', '64', '7', '71', '72', '73', '74', '8', '81', '82', '83', '84', '85', '86'],
...
module.exports = {
  ...
  [`GET ${ApiPrefix}/tasks`](req, res) {
    ...
    res.status(200).json({
      data: tasks.slice((page - 1) * pageSize, page * pageSize),
      total: tasks.length,
    })
  },
